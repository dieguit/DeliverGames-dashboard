...
import { Menu, Icon, Button, Label, Image } from 'semantic-ui-react';
  ...
  render() {
    return (
      <div className="AdminLayout">
        <Menu style={{ width: 250 }} as="div" vertical fixed="left" inverted>
          ...
          <div style={{ background: 'black' }}>
            <Menu inverted style={{ maxWidth: '100%', marginTop: 0 }}>
              <Menu.Menu position="right">
                <Menu.Item>
                  <Button as="div" labelPosition="right" title="Get Token!" onClick={this.logToken}>
                ...
                <Menu.Item>
                  <Button animated onClick={this.signOut.bind(this)}>
                    ...
                    <Button.Content hidden>Bye bye</Button.Content>
                  </Button>
                </Menu.Item>
              </Menu.Menu>
            </Menu>
